...
as begin
	...
	select s.SupplierID, upper(s.CompanyName) as 'NombreCompañia', upper(s.City) as 'Ciudad', upper(isnull(s.Region, 'SIN REGION')) as 'Region', upper(s.Country) as 'Pais', isnull(s.HomePage, 'SIN URL') as 'Url'
